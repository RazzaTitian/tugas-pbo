...
std::optional<Member> MemberService::findMemberById(const std::string& memberId) const {
...
std::vector<Loan> MemberService::listMemberLoans(const std::string& memberId) const {
